          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-[10px] font-mono tracking-[0.1em] text-text-muted hover:text-white transition-colors duration-200 lowercase"
              >
                forgot?
              </Link>
            </div>
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                className="w-full bg-white/[0.03] border border-hairline px-4 py-3 text-sm text-white placeholder:text-text-dim focus:outline-none focus:border-white/30 focus:bg-white/[0.05] transition-all duration-200 pr-10"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-text-dim hover:text-white transition-colors"
