    ...
    <section className="py-20 md:py-32">
      <div className="max-w-[1600px] mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-20">
              ...
              {CLINICAL_SPECS.map((spec) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[11px] font-mono tracking-[0.1em] text-text-muted lowercase pt-0.5">
                      {spec.key}
                    </span>
                  </div>
          ...
          <div>
            <div className="bg-[#0D0D0D] before:absolute before:inset-0 before:bg-white/[0.02] border border-hairline p-8 md:p-12 relative overflow-hidden h-full">
                ...
                <div className="grid grid-cols-2 gap-6">
                  {CORE_BADGES.map((badge) => (
                    <div key={badge.label} className="flex flex-col gap-3">
                      <div className="w-10 h-10 border border-hairline flex items-center justify-center bg-black/20">
                        <Icon src={badge.icon} size={18} opacity={0.7} />
                      </div>
                      <span className="text-xs text-text-muted lowercase max-w-[100px]">
                        {badge.label}
                      </span>
                    </div>
                  ))}
