          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                <Icon
                  src="/icons/test-tube-minimalistic.svg"
                  size={14}
                  opacity={0.25}
                />
              ...
              <p className="text-sm text-text-muted lowercase leading-relaxed">
                every active is declared at a functional concentration. no
                filler claims. no proprietary blends hiding a half-percent
                trace.
              </p>
            </div>
