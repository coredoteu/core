        ...
        <div className="mt-12 md:mt-20 grid grid-cols-1 lg:grid-cols-2 border border-hairline">
          <div className="border-b lg:border-b-0 lg:border-r border-hairline flex flex-col">
            <div className="flex items-center justify-between px-6 md:px-8 py-4 border-b border-hairline bg-white/[0.02]">
              ...
              <span className="font-mono text-[10px] tracking-[0.15em] text-text-muted lowercase">
                live
              </span>
            </div>
            ...
            <div className="flex-1 px-6 md:px-8 py-6 flex flex-col gap-3">
              {logLines.map((line) => (
                <div key={line.id} className="flex items-start gap-4">
                  <span className="font-mono text-[10px] text-text-muted shrink-0 mt-px">
                    {line.id}
                  </span>
                  <span
            ...
            <div className="border-t border-hairline grid grid-cols-3 divide-x divide-white/10">
              {statusNodes.map((node) => (
                <div key={node.key} className="px-5 py-4 flex flex-col gap-1">
                  <span className="font-mono text-[9px] tracking-[0.2em] text-text-muted lowercase">
                    {node.key}
                  </span>
                  <span className="font-mono text-[11px] text-text-muted lowercase">
                    {node.value}
                  </span>
                </div>
              ))}
          ...
          <div className="flex flex-col">
            <div className="relative flex-1 min-h-[300px] md:min-h-[360px] flex items-center justify-center overflow-hidden bg-[#0D0D0D] before:absolute before:inset-0 before:bg-white/[0.02]">
              <div
              ...
              <div className="absolute bottom-5 left-1/2 -translate-x-1/2 z-40">
                <span className="font-mono text-[9px] tracking-[0.3em] text-text-muted lowercase px-3 py-1 border border-hairline bg-[#0D0D0D]/60 backdrop-blur-sm">
                  image redacted
                </span>
              </div>
            </div>

            <div className="border-t border-hairline px-6 md:px-8 py-8 flex flex-col gap-6">
              <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-text-muted lowercase leading-relaxed max-w-prose">
              ...
              <p className="font-mono text-[9px] tracking-[0.15em] text-text-muted lowercase">
